...
SCRIPT = Path(__file__).parents[1] / "scripts" / "known_pose_map_merger.py"
SPEC = importlib.util.spec_from_file_location("known_pose_map_merger", SCRIPT)
MODULE = importlib.util.module_from_spec(SPEC)
SPEC.loader.exec_module(MODULE)
GridData = MODULE.GridData
classify_cell = MODULE.classify_cell
merge_grids = MODULE.merge_grids
validate_grid = MODULE.validate_grid
